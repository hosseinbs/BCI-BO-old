...
if __name__ == '__main__':
    ...
    feature = 'morlet' #'morlet'] #morlet for type 2 and 4 does not work!!!!!
    ...
    BO_selection_types = [ "GPEIOptChooser1", "GPEIOptChooser2", "GPEIOptChooser3", "GPEIOptChooser4", "GPEIOptChooser5", "GPEIOptChooser6", "GPEIOptChooser7", "GPEIOptChooser8", "GPEIOptChooser9", 
                          "RandomForestEIChooser3", "RandomForestEIChooser5", "RandomForestEIChooser6", "RandomForestEIChooser7", "RandomForestEIChooser8",
                          "RandomForestEIChooser9", "RandomChooser6", "RandomChooser7", "RandomChooser8", "RandomChooser9"]
